...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! helpers */ \"./helpers/index.js\");\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (handler);\n\nfunction handler(req, res) {\n  switch (req.method) {\n    case 'GET':\n      return getUsers();\n\n    case 'POST':\n      return createUser();\n\n    default:\n      return res.status(405).end(`Method ${req.method} Not Allowed`);\n  }\n\n  function getUsers() {\n    const users = helpers__WEBPACK_IMPORTED_MODULE_0__[\"usersRepo\"].getAll();\n    return res.status(200).json(users);\n  }\n\n  function createUser() {\n    try {\n      helpers__WEBPACK_IMPORTED_MODULE_0__[\"usersRepo\"].create(req.body);\n      return res.status(200).json({});\n    } catch (error) {\n      return res.status(400).json({\n        message: error\n      });\n    }\n  }\n}//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./pages/api/users/index.js\n");
